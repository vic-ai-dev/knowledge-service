...
def _create_default_evaluator(**kwargs: Any) -> CompositeEvaluator:
    ...
    后续可扩展 deepeval 等后端。工厂注册见 app.factory.factory。
    """
...
class EvalRunner:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        from app.query_engine.hybrid_search import HybridSearch
    ...
    async def run_single(
        ...
        # ── 1. 检索 ──
        t0 = time.monotonic()
        from app.query_engine.query_processor import QueryProcessor
