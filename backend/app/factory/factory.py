...
# ── Embedding ───────────────────────────────────────────
from app.factory.base.base_embedding import BaseEmbedding
...
# ── Splitter ────────────────────────────────────────────
from app.factory.base.base_splitter import BaseSplitter
...
# ── Reranker ────────────────────────────────────────────
from app.factory.base.base_reranker import BaseReranker
...
class RerankerFactory:
    ...
    def create(cls, backend: str | None = None, **kwargs) -> BaseReranker:
        ...
        if backend == "none":
            from app.factory.base.base_reranker import NoOpReranker
            return NoOpReranker()
...
# ── Loader ──────────────────────────────────────────────
from app.factory.base.base_loader import BaseLoader
